...
";
    ...
    <form  action=\"";
        ...
        <input class=\"field-text\" type=\"text\" id=\"username\" name=\"_username\" value=\"";
        // line 11
        ...
        <input class=\"field-text\" type=\"password\" id=\"password\" name=\"_password\" />
...
";
    ...
    {
        return array (  80 => 21,  72 => 11,  67 => 9,  64 => 8,  58 => 6,  56 => 5,  53 => 4,  44 => 3,  15 => 1,);
    }
...
<div class=\"login-container\" >
    <form  action=\"{{ path('login') }}\" method=\"post\">
        <label for=\"username\">Username:</label>
        <input class=\"field-text\" type=\"text\" id=\"username\" name=\"_username\" value=\"{{ last_username }}\" />
