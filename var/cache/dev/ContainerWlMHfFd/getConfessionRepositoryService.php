...
// Returns the private 'App\Repository\ConfessionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ConfessionRepository.php';

return $this->privates['App\Repository\ConfessionRepository'] = new \App\Repository\ConfessionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
