...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\ConfessionType' => function () {
    return ($this->privates['App\Form\ConfessionType'] ?? $this->privates['App\Form\ConfessionType'] = new \App\Form\ConfessionType());
